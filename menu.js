...
document.addEventListener("DOMContentLoaded", () => {
    // Lista de imágenes
    const images = [
        "IMAGENES/principal-1.webp",
        "IMAGENES/principal-2.webp",
        "IMAGENES/principal-3.webp"
    ];
    ...
    // Asignar la imagen seleccionada al elemento <img>
    const imageElement = document.getElementById("random-image");
    imageElement.src = randomImage;


 // Enlace que envuelve la imagen
    const imageLink = document.getElementById("random-image-link");
    imageLink.href = "contacto.html"; // Establece el enlace
});


function scrollToCatalog() {
    // Desplázate al elemento con id="catalog-section"
...
function openPdf() {
    ...
    window.open('docs/catalogo.pdf', '_blank');
}
