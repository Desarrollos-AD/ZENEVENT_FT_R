      ...
      <section className="elegirnos">
        ...
        <div className="elegirnos__items">
          <div className="elegirnos__item">
            <div className="elegirnos__item--icono">
              <svg
            ...
            <h4>Creatividad</h4>
            <p>Ideas frescas y originales para cada evento.</p>
          </div>
          <div className="elegirnos__item">
            <div className="elegirnos__item--icono">
              <svg
            ...
            <h4>Organización</h4>
            <p>Planificación impecable de inicio a fin.</p>
          </div>
          <div className="elegirnos__item">
            <div className="elegirnos__item--icono">
              <svg
            ...
            <h4>Experiencia</h4>
            <p>Más de una década creando momentos inolvidables.</p>
          </div>
          <div className="elegirnos__item">
            <div className="elegirnos__item--icono">
              <svg
            ...
            <p>Todo en un solo lugar, sin complicaciones.</p>
          </div>
        </div>
      </section>
    </div>
